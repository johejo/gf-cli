## gf provisioning export-mute-timings

Exports all mute timings in provisioning format

### Synopsis

Exports all mute timings in provisioning format

Response schema (ExportMuteTimingsOK.Payload):
  apiVersion                                                        number
...
```
gf provisioning export-mute-timings [flags]
```
