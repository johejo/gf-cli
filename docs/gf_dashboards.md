...
* [gf dashboards search-dashboard-snapshots](gf_dashboards_search-dashboard-snapshots.md)	 - Lists snapshots
...
* [gf dashboards update-public-dashboard](gf_dashboards_update-public-dashboard.md)	 - Update public dashboard for a dashboard
