...
* [gf admin-ldap get-user-from-ldap](gf_admin-ldap_get-user-from-ldap.md)	 - Finds an user based on a username in LDAP this helps illustrate how would the particular user be mapped in grafana when synced
