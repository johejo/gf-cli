...
* [gf access-control delete-role](gf_access-control_delete-role.md)	 - Deletes a custom role
...
* [gf access-control list-roles](gf_access-control_list-roles.md)	 - Gets all roles
...
* [gf access-control remove-user-role](gf_access-control_remove-user-role.md)	 - Removes a user role assignment
* [gf access-control set-resource-permissions](gf_access-control_set-resource-permissions.md)	 - Sets resource permissions
* [gf access-control set-resource-permissions-for-built-in-role](gf_access-control_set-resource-permissions-for-built-in-role.md)	 - Sets resource permissions for a built in role
* [gf access-control set-resource-permissions-for-team](gf_access-control_set-resource-permissions-for-team.md)	 - Sets resource permissions for a team
* [gf access-control set-resource-permissions-for-user](gf_access-control_set-resource-permissions-for-user.md)	 - Sets resource permissions for a user
