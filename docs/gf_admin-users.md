...
* [gf admin-users admin-logout-user](gf_admin-users_admin-logout-user.md)	 - Logouts user revokes all auth tokens devices for the user user of issued auth tokens devices will no longer be logged
