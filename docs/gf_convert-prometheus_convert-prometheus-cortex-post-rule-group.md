## gf convert-prometheus convert-prometheus-cortex-post-rule-group
...
Response schema (ConvertPrometheusCortexPostRuleGroupAccepted.Payload):
  error      string
  errorType  string
  status     string
...
```
  ...
  -h, --help                                              help for convert-prometheus-cortex-post-rule-group
